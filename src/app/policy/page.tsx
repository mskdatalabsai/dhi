            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
              ...
              <section className="mb-12">
                ...
                <div className="prose prose-gray dark:prose-invert max-w-none">
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                    ...
                    policies are designed to ensure fairness, data security, and
                  ...
                  <ul className="space-y-3 text-gray-700 dark:text-gray-300">
                    ...
                    <li>
                      ...
                      security standards; your responses and personal
                      information remain confidential and encrypted.
                    </li>
                    <li>
                      <strong>Fair Pricing</strong> – Simple and affordable
                      pricing (₹95 in India / $5 globally) to make career
                      guidance accessible to everyone.
                    </li>
                    <li>
                      <strong>Continuous Improvement</strong> – We evolve our
                      assessments, recommendations, and services regularly to
                      stay aligned with market needs and user feedback.
                    </li>
                    <li>
              ...
              <section>
                ...
                <div className="prose prose-gray dark:prose-invert max-w-none">
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                    ...
                    <strong>EdTech and Career Guidance industry</strong>,
                    blending advanced technology with personal growth.
                  </p>
              ...
              <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  For questions about our policies, please contact us through
                  our
                  <a
                    href="/contact"
